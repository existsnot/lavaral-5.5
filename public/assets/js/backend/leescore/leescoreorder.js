        ...
        index: function () {
            ...
            table.bootstrapTable({
                ...
                onExpandRow: function(index, row, $detail) {
                    ...
                    var firstname = (row.address_info != null) ? row.address_info.firstname : '-';
                    var lastname = (row.address_info != null) ? row.address_info.lastname : '-';
                    ...
                    $.ajax({
                        type: "post",
                        url: "leescoreorder/getOrderGoods", //子表请求的地址

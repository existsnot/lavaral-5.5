define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'market/couisslog/index',
                    add_url: 'market/couisslog/add',
                    edit_url: 'market/couisslog/edit',
                    del_url: 'market/couisslog/del',
                    multi_url: 'market/couisslog/multi',
                    table: 'coupon_issue_log',
                }
            });
